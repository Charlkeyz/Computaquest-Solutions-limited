...
export const SITE_NAME = "Computaquest Solutions limited";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://computaquest.com"; // Update with actual URL
export const TWITTER_HANDLE = "@Computaquest";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "Computaquest Solutions limited Ltd provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
      "Computaquest Solutions limited",
  ...
  home: {
    ...
    description:
      "Innovate and grow with Computaquest. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your Computaquest client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "Computaquest dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with Computaquest Solutions limited and access premium tech resources.",
    keywords: [
      "Get started with Computaquest Solutions limited",
      "Project onboarding",
      "Digital partnership",
    ],
  },
