  ...
  return (
    <>
      ...
      <div className="sm:hidden fixed bottom-0 z-50 w-full">
        ...
        <div className="relative bg-primary-100 border-t border-primary-200 backdrop-blur-sm">
          {/* Navigation Items */}
                ...
                <button
                  ...
                  <div
                    className={`relative p-2 rounded-full transition-all duration-200 ${
                      isActive ?
                        "bg-white text-primary-100 shadow-lg"
                      : "text-white/70 group-hover:bg-primary-200"
                    }`}>
