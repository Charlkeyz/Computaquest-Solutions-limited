...
const ProductCard = ({
  ...
  return (
    <Link
      ...
      className="flex flex-col gap-2 cursor-pointer items-center w-full h-[230px] sm:h-[260px] bg-white pb-2 hover:shadow-xl hover:scale-105 transition rounded-lg">
      ...
      <div className="sm:flex-[.2] flex flex-col gap-2 px-2">
        ...
        <h4
          className="truncate text-xs sm:text-sm text-text_color font-[400] leading-[1.3] w-full max-w-full text-center"
          title={description}>
          {description}
        </h4>
      </div>
