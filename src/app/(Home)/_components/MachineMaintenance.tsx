...
const MachineMaintenance = () => {
  return (
    <section className="w-full grid grid-cols-1 md:grid-cols-2 min-h-[800px] bg-white overflow-hidden">
      ...
      <div className="bg-primary-300 flex flex-col justify-center p-8 sm:p-12 md:p-16 lg:p-24 space-y-8">
        {/* Main Heading */}
        ...
        <Link
          href="/contact-us"
          className="w-fit bg-white text-primary-300 font-bold uppercase tracking-widest px-8 py-3.5 rounded-sm hover:bg-gray-100 transition-all active:scale-95 shadow-lg">
          Contact Us
        </Link>
      </div>
