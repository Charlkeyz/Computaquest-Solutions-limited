...
const RefundPolicy = () => {
  ...
  return (
    <div className="text-gray-600 space-y-6 text-xs sm:text-sm">
      <p>
        At Computaquest Solutions limited, we strive for 100% accuracy in every
      ...
      <section>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-2">
          ...
          <li>
            ...
            our error, Computaquest Solutions limited covers the return
            shipping. For all other approved returns, the customer bears the
            cost.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          At Computaquest Solutions limited, we act as your dedicated
          procurement agent. While we vet suppliers, we do not control their
          internal packing process. In the rare event that a supplier fails to
          ship an item or sends an incomplete order, the following policy
          applies:
        </p>
        <ul className="list-disc pl-5 mt-2 space-y-2">
          <li>
